...
mod comprehensive_integration_tests {
    ...
    use crate::app_logic::{MenuStructure, MenuItem, create_menu_structure, handle_menu_event, MenuAction};
    use crate::tray::{TrayIconAction, handle_tray_icon_click, calculate_show_menu_on_left_click, get_tray_tooltip};
    use std::sync::Mutex;
